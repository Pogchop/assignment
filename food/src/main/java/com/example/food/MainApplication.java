...
public class MainApplication {
    public static void main(String[] args) {
        ...
        Set<Class<?>> checkforeignkey = reflections.getTypesAnnotatedWith(HaveForeignKey.class);
        for (Class<?> clazz :
                checkforeignkey) {
